...
class FCSysModulePropertiesComp(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        #New Input
        self.add_input('pwr_el_maxfcstack', val=1.0*np.ones(nn))#, units='kW'
    ...
    def compute(self, inputs, outputs):
        ...
        pwr_el_maxfcstack = inputs['pwr_el_maxfcstack']/1
        ...
        # print('Power Max per FC Stack: ', pwr_el_maxfcstack)

        # Mass of Fuel Cell Stack
        # mass_fcstack = (pwr_el_del_per_maxfcsysmodule/1000) / pwr_dens_fcstack #[kW]/[kW/kg]
        mass_fcstack = (pwr_el_maxfcstack/1000) / pwr_dens_fcstack #[kW]/[kW/kg]
        # print('Mass per FC Stack: ', mass_fcstack)
        ...
        # print('Mass per Compressor: ', mass_cmprsr)
